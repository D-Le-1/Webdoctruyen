...
const GridMotion: FC<GridMotionProps> = ({
  ...
  return (
    <div ref={gridRef} className="size-full overflow-hidden rounded-lg">
      <section
      ...
      >
              ...
              {Array.from({ length: 7 }, (_, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="relative">
                    <div className="relative flex size-full items-center justify-center overflow-hidden rounded-[10px] bg-[#111] text-[1.5rem] text-white">
        ...
        <div className="pointer-events-none relative left-0 top-0 size-full"></div>
      </section>
    </div>
  )
}
